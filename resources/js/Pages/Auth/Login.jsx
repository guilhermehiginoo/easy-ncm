            ...
            <div className="mt-6">
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-[#0f172a] text-[#92adc9]">Ou</span>
                    </div>
                </div>
                ...
                <a
                    ...
                    className="mt-4 w-full flex items-center justify-center gap-3 py-3 px-4 bg-white text-gray-700 font-medium rounded-lg hover:bg-gray-100 transition-colors"
                >
